...
define(function(require,exports,module){
    ...
    $.xDialog = function(){
        ...
        var defaults = {
            ...
            cancel:null,             //取消按钮回调函数，函数如果返回false将阻止弹出层关闭
            overlayClose:true,       //点击遮罩层是否可以关闭
            overlayColor:'black',  //遮罩层颜色
            type:'modal',            //弹出框类型，'alert','confirm','modal'
        ...
        plugin.create = function(){
            ...
            if(this.settings.type === "alert"){
                $('<div>',{'class':'x-buttons clearfix'}).html('<a class=\"x-ok g-button blue\" href=\"javascript:;\">确定<\/a>').appendTo(this.dialog);
            }
            else if(this.settings.type === "confirm"){
                $('<div>',{'class':'x-buttons clearfix'}).html('<a class=\"x-ok g-button blue\" href=\"javascript:;\">确定<\/a><a class=\"x-cancel g-button\" href=\"javascript:;\">取消<\/a>').appendTo(this.dialog);
            }
